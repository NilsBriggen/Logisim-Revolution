...
public class ZoomControl extends JPanel {
  ...
  /** The model of the active editor, or null for an editor without document zoom. */
  ...
  private class GridIcon extends JComponent
    ...
    protected void paintComponent(Graphics g) {
      ...
      // The foreground follows the look and feel, so the glyph stays visible on a dark toolbar.
      g.setColor(state ? getBackground() : getForeground());
