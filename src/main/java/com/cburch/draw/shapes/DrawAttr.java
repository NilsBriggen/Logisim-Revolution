...
public class DrawAttr {
  ...
  public static final Font DEFAULT_FIXED_PICH_FONT = new Font(Font.MONOSPACED, Font.PLAIN, 12);
  public static final Font DEFAULT_NAME_FONT = new Font(Font.MONOSPACED, Font.BOLD, 14);
